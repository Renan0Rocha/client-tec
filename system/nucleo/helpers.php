...
{
    /*
public static function filter_input_fix ($type, $variable_name, $filter = FILTER_DEFAULT)
{
    $checkTypes =[
        INPUT_GET,
        INPUT_POST,
 ...
 */
    ...
    {
        /*Exemplo para chamar função estática dentro de outra estática

        $cpf = self::exemplopublic static functionStatic($cpf);
    ...
    public static function filtrarString($string): string
    {
...
public static public static function slug(string $string): string
{
...
*/
    ...
    public static function formatarNumero(float $numero = null): string
    {
